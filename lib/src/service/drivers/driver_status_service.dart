...
class DriverStatusSerive {
 ...
 // final baseUrl = "http://192.168.20.49:8080/api/v1/drivers/status";
  ...
  Future<void> connectDriver(int driverId, LatLng position) async {
    const String baseUrl = 'https://3e2dd06df8fb.ngrok-free.app/api/v1';
  ...
  Future<void> disconnectDriver(int driverId) async {
    const String baseUrl = 'https://3e2dd06df8fb.ngrok-free.app/api/v1/drivers';
  ...
  const String baseUrl = 'https://3e2dd06df8fb.ngrok-free.app/api/v1/drivers/get/status/';
    try {
