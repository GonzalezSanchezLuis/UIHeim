...
class _CalculatePriceState extends State<CalculatePrice> {
  ...
  final locationService = LocationService(googleApiKey: "AIzaSyACSE_ZDRzWaajv35TLstALgz-NBJJnxoc");
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          icon: locationViewModel.isLoading ?  const SizedBox(
                            width: 24,
                            height: 24,
                            child: CircularProgressIndicator(
                              ...
                              onPressed: locationViewModel.isLoading ? null : () async {
  ...
  Future<void> _handleRequestVehicle() async {
    ...
    if (origin.isEmpty) {
      Position? position = await locationViewModel.updateLocation(context);
      if (position != null) {
