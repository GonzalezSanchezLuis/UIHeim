...
import 'package:holi/src/view/screens/user/driver_profile_view.dart';
...
/*class DriverInfoCard extends StatelessWidget {
  ...
  const DriverInfoCard({super.key, required this.moveData,required this.vehicleImageUrl});
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                '${moveData['plate']} • ${moveData['vehicleType']}',
            ...
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  iconSize: 20,
                  onPressed: () {
                    launchUrl(Uri.parse("tel:${moveData['phone']}"));
                  },
